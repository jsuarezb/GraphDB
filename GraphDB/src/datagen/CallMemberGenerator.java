...
//		conn.createStatement().execute("DROP TABLE IF EXISTS grupo2v" + schema + ".Call");
//		conn.createStatement().execute("DROP TABLE IF EXISTS grupo2v" + schema + ".EmisorReceptor");
//		conn.createStatement().execute("DROP TABLE IF EXISTS grupo2v" + schema + ".DateTime");
//		conn.commit();
//	}
//	
